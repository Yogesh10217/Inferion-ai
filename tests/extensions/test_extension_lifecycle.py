...
from app.extensions.extension import Extension, ExtensionManifest, ExtensionType, ExtensionVersion
...
def test_extension_atomic_upgrade_and_rollback():
    ...
    m1 = ExtensionManifest(
        identifier="ext.test", name="Ext Test", version="1.0.0", publisher_id="p1", extension_type=ExtensionType.TOOL
    )
    ...
    m2 = ExtensionManifest(
        identifier="ext.test", name="Ext Test", version="2.0.0", publisher_id="p1", extension_type=ExtensionType.TOOL
    )
