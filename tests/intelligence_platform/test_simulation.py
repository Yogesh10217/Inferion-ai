...
from app.intelligence_platform.simulation import SimulationEngine, SimulationScenario, SimulationInput, DeterministicSimulationStrategy
...
def test_simulation_never_executes_in_production():
    ...
    sim_input = SimulationInput(scenario_name="Rollback_Check", target_resource_id="gateway_prod", action_type="ROLLBACK")
