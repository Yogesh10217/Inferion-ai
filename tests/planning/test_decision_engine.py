...
def test_evaluate_strategies():
    opts = [
        StrategyOption(
            name="Fast", description="", estimated_cost=0.001, estimated_duration_seconds=2.0, confidence_score=0.9
        ),
        StrategyOption(
            name="Slow", description="", estimated_cost=0.10, estimated_duration_seconds=50.0, confidence_score=0.95
        ),
    ]
