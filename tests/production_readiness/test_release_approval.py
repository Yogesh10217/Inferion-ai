...
def test_all_approved_grants_approval():
    reqs = [
        ApprovalRequirement(
            category=ApprovalCategory.TECHNICAL, approver_role="Lead Architect", status=ApprovalStatus.APPROVED
        ),
        ApprovalRequirement(
            category=ApprovalCategory.SECURITY, approver_role="Security Officer", status=ApprovalStatus.APPROVED
        ),
        ...
        ApprovalRequirement(
            category=ApprovalCategory.RELEASE, approver_role="Release Manager", status=ApprovalStatus.APPROVED
        ),
    ]
