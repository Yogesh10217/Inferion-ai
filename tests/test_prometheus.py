...
def test_metrics_mapper_histogram_buffering():
    ...
    prov_count = registry.registry.get_sample_value('test_sys_provider_latency_seconds_count', {"provider_id": "openai", "instance_id": "openai-1"})
    assert prov_count == 1
    assert registry.registry.get_sample_value('test_sys_provider_latency_seconds_sum', {"provider_id": "openai", "instance_id": "openai-1"}) == 0.3
