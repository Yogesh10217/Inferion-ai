...
def get_client(event_loop):
    ...
    async def setup_db():
        ...
        async with async_session_maker() as session:
            ...
            user = User(
                id="admin_user_id", username="admin", email="admin@test.com", password_hash="hash", is_admin=True
            )
            ...
            membership = Membership(
                user_id="admin_user_id", organization_id="test_org_id", role_id="admin", status="active"
            )
