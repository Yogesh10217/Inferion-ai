...
import pytest
from app.governance_platform.risk import RiskManager, RiskCategory
...
def test_strict_multi_tenant_isolation():
    ...
    v_mgr.record_violation("Viol A", ViolationType.POLICY_VIOLATION, ViolationSeverity.LOW, "res_A", tenant_id="Tenant_A")
    ...
    v_mgr.record_violation("Viol B", ViolationType.POLICY_VIOLATION, ViolationSeverity.LOW, "res_B", tenant_id="Tenant_B")
