...
def test_promotion_policy_evaluation():
    ...
    # Good eval -> Approved
    good_eval = EvaluationResult(asset_id="a1", version_number="1.0.0", overall_score=95.0, safety_score=98.0, hallucination_rate=0.01)
    ...
    # Bad eval -> Rejected
    bad_eval = EvaluationResult(asset_id="a1", version_number="1.0.0", overall_score=80.0, safety_score=90.0, hallucination_rate=0.10)
