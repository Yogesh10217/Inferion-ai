...
class QuotaService:
    ...
    async def _check_scope_quota(self, session: AsyncSession, scope_type: str, scope_id: str, date_str: str) -> None:
        ...
        while policy and policy.parent_policy_id:
            ...
            if policy.tokens_per_day is None: policy.tokens_per_day = parent_policy.tokens_per_day
            if policy.requests_per_day is None: policy.requests_per_day = parent_policy.requests_per_day
