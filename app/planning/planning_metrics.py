...
plans_completed_total = Counter(
    "plans_completed_total",
    "Total number of plans completed successfully",
    ["tenant_id"]
)

plans_failed_total = Counter(
    "plans_failed_total",
    "Total number of plans failed",
