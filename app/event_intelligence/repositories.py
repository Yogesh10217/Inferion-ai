...
class EventRepository(TenantScopedRepository[Any]):
...
class EventCorrelationRepository(EventRepository):
    pass


class AutomationRepository(EventRepository):
    pass


class InvestigationRepository(EventRepository):
    pass


class ResolutionRepository(EventRepository):
    pass
