...
class WorkflowIntegrationAdapter:
    ...
    def invoke_connector_step(
        self, workflow_id: str, connector_name: str, action: str, tenant_id: str = "global"
    ) -> Dict[str, Any]:
        logger.info(
            f"[WORKFLOW INTEGRATION ADAPTER] Workflow '{workflow_id}' invoked connector '{connector_name}' action '{action}'"
        )
