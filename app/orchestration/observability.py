...
if PROMETHEUS_AVAILABLE:
    ORCH_EXECUTIONS_TOTAL = Counter(
        "ai_orchestration_workflow_executions_total", "Total workflow executions", ["tenant_id", "status"]
    )
    ORCH_DURATION_SECONDS = Histogram(
        "ai_orchestration_workflow_duration_seconds", "Workflow duration seconds", ["tenant_id"]
    )
    ...
    ORCH_COMPENSATIONS_TOTAL = Counter(
        "ai_orchestration_compensations_total", "Total saga compensations", ["tenant_id"]
    )
