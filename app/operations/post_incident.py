...
class PostIncidentReport:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "lessons_learned": [SecretsSanitizer.sanitize_string(lesson) for lesson in self.lessons_learned],
...
class PostIncidentReportGenerator:
    ...
    def generate_report(
        ...
        return PostIncidentReport(
            ...
            lessons_learned=[SecretsSanitizer.sanitize_string(lesson) for lesson in lessons],
