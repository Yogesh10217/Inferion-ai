...
class RiskPropagationEngine:
    ...
    def build_graph(
        self,
        tenant_id: str,
        edges_data: Optional[List[Tuple[IntelligenceDomain, IntelligenceDomain, float]]] = None
    ...
    def evaluate_risk_propagation(
        ...
        impacted = impacted_domains or [IntelligenceDomain.SECURITY, IntelligenceDomain.DATA, IntelligenceDomain.OPERATIONS]
