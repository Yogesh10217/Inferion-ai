...
def create_app() -> FastAPI:
    ...
    app.include_router(data_fabric_router, prefix=settings.api_prefix)
    app.include_router(mlops_router, prefix=settings.api_prefix)
    app.include_router(finops_router, prefix=settings.api_prefix)
    app.include_router(operations_router, prefix=settings.api_prefix)
    app.include_router(governance_platform_router, prefix=settings.api_prefix)
    app.include_router(identity_router, prefix=settings.api_prefix)
    app.include_router(orchestration_router, prefix=settings.api_prefix)
    app.include_router(knowledge_platform_router, prefix=settings.api_prefix)
    app.include_router(integrations_router, prefix=settings.api_prefix)
    app.include_router(developer_platform_router, prefix=settings.api_prefix)
    app.include_router(application_platform_router, prefix=settings.api_prefix)
    app.include_router(platform_operations_router, prefix=settings.api_prefix)
    ...
    app.include_router(security_intelligence_router, prefix=settings.api_prefix)
    app.include_router(ai_lifecycle_router, prefix=settings.api_prefix)
    app.include_router(event_intelligence_router, prefix=settings.api_prefix)
    app.include_router(knowledge_intelligence_router, prefix=settings.api_prefix)
    app.include_router(agent_orchestration_router, prefix=settings.api_prefix)
    app.include_router(platform_resilience_router, prefix=settings.api_prefix)
    app.include_router(control_assurance_router, prefix=settings.api_prefix)
    app.include_router(access_intelligence_router, prefix=settings.api_prefix)
    app.include_router(integration_intelligence_router, prefix=settings.api_prefix)
    app.include_router(operations_intelligence_router, prefix=settings.api_prefix)
    app.include_router(finops_intelligence_router, prefix=settings.api_prefix)
    app.include_router(data_intelligence_router, prefix=settings.api_prefix)
    app.include_router(model_intelligence_router, prefix=settings.api_prefix)
    app.include_router(decision_governance_router, prefix=settings.api_prefix)
    app.include_router(knowledge_assurance_router, prefix=settings.api_prefix)
    app.include_router(identity_assurance_router, prefix=settings.api_prefix)
    app.include_router(operations_assurance_router, prefix=settings.api_prefix)
    app.include_router(security_assurance_router, prefix=settings.api_prefix)
    app.include_router(unified_intelligence_router, prefix=settings.api_prefix)
    app.include_router(decision_intelligence_router, prefix=settings.api_prefix)
    app.include_router(autonomous_assurance_router, prefix=settings.api_prefix)
    app.include_router(continuous_assurance_router, prefix=settings.api_prefix)
    app.include_router(reliability_intelligence_router, prefix=settings.api_prefix)
    app.include_router(runtime_intelligence_router, prefix=settings.api_prefix)
    app.include_router(capacity_intelligence_router, prefix=settings.api_prefix)
    app.include_router(platform_integration_router, prefix=settings.api_prefix)
    app.include_router(platform_hardening_router, prefix=settings.api_prefix)
