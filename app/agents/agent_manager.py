...
class AgentManager:
    def __init__(self, registry: Optional[AgentRegistry] = None, session_manager: Optional[AgentSessionManager] = None):
    ...
    def create_agent_from_template(
        self, agent_id: str, template_name: str, overrides: Optional[Dict[str, Any]] = None
    ) -> AgentConfig:
    ...
    async def resume_session(
        self, session_id: str, approval_decision: Optional[bool] = None, context: Optional[AgentContext] = None
    ) -> AgentState:
