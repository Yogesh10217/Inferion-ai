...
autonomous_runs_total = Counter(
    ...
    "Total number of autonomous executions started",
    ["tenant_id", "execution_mode"]
)

autonomous_runs_active = Gauge(
    "autonomous_runs_active",
    "Gauge of currently active autonomous runs",
    ["tenant_id"]
)

autonomous_runs_failed = Counter(
    "autonomous_runs_failed",
    "Total number of failed autonomous executions",
    ["tenant_id", "error_type"]
)

autonomous_runs_completed = Counter(
    "autonomous_runs_completed",
    "Total number of completed autonomous executions",
    ["tenant_id"]
)
...
autonomous_checkpoints_total = Counter(
...
autonomous_recoveries_total = Counter(
    ...
    "Total checkpoint recoveries performed",
    ["tenant_id"]
)

autonomous_cost_total = Counter(
    "autonomous_cost_total",
    "Total dollar cost incurred by autonomous runs",
    ["tenant_id"]
)
