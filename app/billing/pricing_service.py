...
class PricingService:
    ...
    async def seed_default_rules(self) -> None:
        ...
        examples = [
            PricingRule(provider="openai", model="gpt-4", input_cost_per_1k_tokens=0.03, output_cost_per_1k_tokens=0.06),
            PricingRule(provider="openai", model="gpt-3.5-turbo", input_cost_per_1k_tokens=0.0015, output_cost_per_1k_tokens=0.002),
            PricingRule(provider="anthropic", model="claude-3-opus", input_cost_per_1k_tokens=0.015, output_cost_per_1k_tokens=0.075),
